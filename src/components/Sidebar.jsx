    ...
    <>
      <aside className="w-[260px] h-screen bg-white border-r border-gray-100 flex flex-col flex-shrink-0 select-none overflow-hidden">
        ...
        <div className="px-3 mb-1 space-y-0.5 flex-shrink-0">
          ...
          <NavBtn active={currentView === 'daily-log'} onClick={() => onNavigate('daily-log')}
            icon={<CalendarIcon />} label="daily log" />
...
const CalendarIcon = () => (<SvgIcon><path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></SvgIcon>);
